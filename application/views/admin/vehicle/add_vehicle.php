...
<section id="content">
  <div class="page page-forms-validate">
    <div class="pageheader">
      ...
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li> <a href="javascript::">Add Vehicle </a> </li>
        </ul>
      </div>
    </div>
    ...
    <!-- row -->
    <div class="row">
      <?=form_open_multipart(base_url().'add_vehicle',array('id'=>'add_vehicle','role'=>'form'));?>
      <!-- col -->
      <div class="col-md-12">
        ...
        <section class="tile"> 
          ...
          <div class="tile-body">
              ...
              <div class="form-group name_class col-md-3" style="padding:0px;">
                <label for="name">Company Name <span class="required">*</span></label><br />
				...
				{
					?>
                    <option value="<?=$v->contactID?>" ><?=$v->companyName?></option>
                    <?php 
				}
				?>
          ...
          <div class="tile-body">
              ...
              <div class="form-group col-md-3">
                ...
                <input type="text" name="vehno" id="vehno" class="form-control" required placeholder=" Enter Vehicle number" >
                <ul class="parsley-errors-list" id="parsley-id-1328">
                </ul>
              </div>
              <div class="form-group col-md-3">
                <label for="contactemail">Vehicle make </label>
                <input type="text" name="vehmake" id="vehmake" class="form-control" placeholder=" Enter Vehicle make" >
                <ul class="parsley-errors-list" id="parsley-id-1328">
                </ul>
              </div>
              ...
              <div class="form-group col-md-3">
                ...
                <input type="text" name="roadpermitno" id="roadpermitno" class="form-control"  placeholder=" Enter Road permit number" >
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
            ...
            <div class="row">
              <div class="form-group col-md-3">
                ...
                <input type="text" name="validity" id="validity" class="form-control datepicker "  placeholder="MM-DD-YYYY" data-format="L"  >
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
              <div class="form-group col-md-3">
                <label for="contactemail">Insurance policy details </label>
                <input type="text" name="insurancepolicydtls" id="insurancepolicydtls" placeholder=" Enter Insurance policy details"class="form-control" >
                <ul class="parsley-errors-list" id="parsley-id-1328">
                </ul>
              </div>
              ...
              <div class="tile-footer text-right bg-tr-black col-md-9 lter dvd dvd-top"> 
                ...
                <a  href="<?= base_url()?>vehicleowner"  class="btn btn-warning"><i class="fa fa-hand-o-left"></i> Go Back</a>
                  <input type="submit" class="btn bg-greensea" id="add_form" value="Add Vehicle" >
