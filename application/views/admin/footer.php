...
<div class="modal splash fade" id="form-edit-submit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title custom-font">Confirmation!</h3>
            ...
            <div class="modal-body">
                <p id="confirmation-msg2">Are you sure you would like to Update this record?</p>
            </div>
