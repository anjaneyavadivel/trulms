...
<section id="content">
  <div class="page page-forms-validate">
    ...
    <!-- row -->
    <div class="row">
      <?=form_open_multipart(base_url().'add_vehicleagent',array('id'=>'form4','role'=>'form','data-parsley-validate'=>''));?>
      <!-- col -->
      <div class="col-md-12">
          ...
          <div class="tile-body">
            <div class="row">
              ...
              <div class="form-group col-md-3">
                ...
                <input type="text" name="loadingadvno" id="loadingadvno" class="form-control" placeholder=" Enter Loading Advance" data-parsley-id="1328">
                <ul class="parsley-errors-list" id="parsley-id-1328">
                </ul>
              </div>
              <div class="form-group col-md-3">
