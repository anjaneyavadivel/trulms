...
<section id="content">
  <div class="page page-forms-validate">
    ...
    <?php if(isset($view) && $view->num_rows()>0){
		...
		?>
    <div class="row">
      <?=form_open_multipart(base_url().'approve_vehicleagent/'.$v->agentID,array('id'=>'form4','role'=>'form','data-parsley-validate'=>''));?>
      <!-- col -->
      <div class="col-md-12">
          ...
          <div class="tile-body">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-3">
                ...
                <input type="email" name="emailss" id="contactemail" required placeholder=" Enter Email ID-1"class="form-control" data-parsley-id="1328" value="<?=$v->email1?>">
                <ul class="parsley-errors-list" id="parsley-id-1328">
                </ul>
              </div>
              <div class="form-group col-md-3">
            ...
            <div class="row">
              ...
              <div class="tile-footer text-right bg-tr-black col-md-6 lter dvd dvd-top"> 
                <!-- SUBMIT BUTTON --> 
                <a  href="javascript::" data-toggle="modal" data-target="#active-deactive1" data-options="splash-2 splash-ef-11" role="button" tabindex="0" onclick="active_deactive_class('<?= base_url()?>vehicleagent','3')" class="btn btn-lightred">Back</a>
