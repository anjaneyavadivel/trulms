                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="javascript::">Update Role</a>
                                </li>
                            </ul>
...
<?php $this->load->view('admin/msg')?>
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header bg-greensea  dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Update</strong> Role</h1>
 ...
 <?=form_open_multipart(base_url().'edit_role/'.$v->roleID,array('class'=>'form-horizontal','id'=>'edit_role','role'=>'form'));?>
...
<input type="hidden" value="<?=$v->roleID?>" name="roleID" id="roleID" />
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">Role Description</label>
                                                ...
                                                <input type="text" name="description" class="form-control" placeholder="Role Role" value="<?=$v->description?>">
                                ...
                                <div class="tile-footer text-right bg-tr-black lter dvd dvd-top">
                                    ...
                                    <!--<a  href="javascript::" data-toggle="modal" data-target="#active-deactive1" data-options="splash-2 splash-ef-11" role="button" tabindex="0" onclick="active_deactive_class('<?= base_url()?>role','3')" class="btn btn-warning"><i class="fa fa-hand-o-left"></i> Go Back</a>-->
                                     <a  href="<?= base_url()?>role"  class="btn btn-warning"><i class="fa fa-hand-o-left"></i> Go Back</a>
