...
<section id="content">
  <div class="page page-forms-validate">
    ...
    <!-- row -->
    <div class="row"> 
      <?=form_open_multipart(base_url().'add_employee ',array('id'=>'add_employee','role'=>'form'));?>
      <!-- col -->
      <div class="col-md-12"> 
          ...
          <div class="tile-body">
            <div class="row">
              ...
              <div class="form-group col-md-3">
                <label for="name">Date Of Birth	 </label>
                                <input type="text" name="dob" id="dob"  class="form-control datepicker "  placeholder="MM-DD-YYYY" data-format="L" >
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
              <div class="form-group col-md-3">
             ...
             <div class="form-group col-md-3">
                ...
                <input type="text" name="fathername" id="fathername" required placeholder="Father name"class="form-control" >
            ...
            <div class="row">
              ...
              <div class="form-group col-md-3">
                ...
                <input type="text" name="mobile" id="mobile" placeholder=" Enter Mobile Number" required class="form-control" >
                <ul class="parsley-errors-list" id="parsley-id-1328">
                </ul>
              </div>
              <div class="form-group col-md-3">
                <label for="name">Emergency Contact Person </label>
                <input type="text" name="emergencycontactperson" id="emergencycontactperson" class="form-control"placeholder=" Enter Emergency Contact Person" >
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
                <div class="form-group col-md-3">
                <label for="name">Emergency Contact </label>
                <input type="text" name="emergencycontact" id="emergencycontact" class="form-control" placeholder=" Enter Emergency Contact">
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
               ...
               <div class="form-group col-md-3">
                ...
                <input type="email" name="mailoffice" id="mailoffice" class="form-control" placeholder=" Enter Mail office" >
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
              ...
              <div class="form-group col-md-3">
                ...
                <input type="email" name="mailpersonal" id="mailpersonal" class="form-control" placeholder=" Enter Mail Personal ">
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
              <div class="form-group col-md-3">
                <label for="name">Address Line 1 <span class="required">*</span></label>
                <input type="text" name="addressline1" id="addressline1" required class="form-control" placeholder=" Enter Address Line 1">
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
               <div class="form-group col-md-3">
                <label for="contactemail">Address Line 2  </label>
                <input type="text" name="addressline2" id="addressline2" placeholder=" Enter Address 2" class="form-control" >
                <ul class="parsley-errors-list" id="parsley-id-1328">
                </ul>
              </div>
              <div class="form-group col-md-3">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-3">
               ...
               <input type="text" name="joiningdate" id="joiningdate" required class="form-control datepicker "  placeholder="MM-DD-YYYY" data-format="L" >
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
              ...
              <!-- <a  href="javascript::" data-toggle="modal" data-target="#active-deactive1" data-options="splash-2 splash-ef-11" role="button" tabindex="0" onclick="active_deactive_class('<?= base_url()?>employee','3')" class="btn btn-warning"><i class="fa fa-hand-o-left"></i> Go Back</a>-->
               ...
               <input type="submit" class="btn bg-greensea" id="add_form" value="Add Department" >
                                   ...
                                   <a  href="javascript::" data-toggle="modal" data-target="#form-submit" id="form_submiting" data-options="splash-2 splash-ef-11" role="button" tabindex="0"  class="btn btn-greensea" style="display:none">Submit</a>
                                    <input type="submit" class="btn btn-default" id="new_button" onclick="form_submit('add_employee')" value="Submit" style="display:none" >
            </div>
