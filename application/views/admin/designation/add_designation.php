...
<?php $this->load->view('admin/msg')?>
 ...
 <?=form_open_multipart(base_url().'add_designation',array('class'=>'form-horizontal','id'=>'add_designation','role'=>'form'));?>
                                ...
                                <div class="tile-footer text-right bg-tr-black lter dvd dvd-top">
                                    ...
                                    <!--<a  href="javascript::" data-toggle="modal" data-target="#active-deactive1" data-options="splash-2 splash-ef-11" role="button" tabindex="0" onclick="active_deactive_class('<?= base_url()?>designation','3')" class="btn btn-warning"><i class="fa fa-hand-o-left"></i> Go Back</a>-->
                                     <a  href="<?= base_url()?>designation"  class="btn btn-warning"><i class="fa fa-hand-o-left"></i> Go Back</a>
                                    <input type="submit" class="btn bg-greensea" id="add_form" value="Add Designation" >
                                   ...
                                   <a  href="javascript::" data-toggle="modal" data-target="#form-submit" id="form_submiting" data-options="splash-2 splash-ef-11" role="button" tabindex="0"  class="btn btn-greensea" style="display:none">Submit</a>
                                    <input type="submit" class="btn btn-default" id="new_button" onclick="form_submit('add_designation')" value="Submit" style="display:none" >
                                </div>
                                <!-- /tile footer -->
