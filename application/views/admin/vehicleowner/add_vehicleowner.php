...
<section id="content">
  <div class="page page-forms-validate">
    ...
    <!-- row -->
    <div class="row">
      <?=form_open_multipart(base_url().'add_vehicleowner',array('id'=>'add_vehicleowner','role'=>'form'));?>
      <!-- col -->
      <div class="col-md-12">
            ...
            <div class="row">
              ...
              <div class="tile-footer text-right bg-tr-black col-md-6 lter dvd dvd-top"> 
                ...
                <a  href="<?= base_url()?>vehicleowner"  class="btn btn-warning"><i class="fa fa-hand-o-left"></i> Go Back</a>
                  <input type="submit" class="btn bg-greensea" id="add_form" value="Add Vehicleowner" >
