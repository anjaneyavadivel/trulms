...
<section id="content">
  <div class="page page-forms-validate">
    <div class="pageheader">
      <h2>Approve Vehicle Owner</h2>
      <div class="page-bar">
        <ul class="page-breadcrumb">
          <li> <a href="<?= base_url()?>"><i class="fa fa-home"></i> HOME</a> </li>
          <li> <a href="<?= base_url()?>vehicleowner">Vehicle Owner</a> </li>
          <li> <a href="javascript::">Approve Vehicle Owner</a> </li>
        </ul>
      </div>
    </div>
    ...
    <?php if(isset($view) && $view->num_rows()>0){
		...
		?>
    <div class="row">
      <?=form_open_multipart(base_url().'approve_vehicleowner/'.$v->ownerID,array('id'=>'form4','role'=>'form','data-parsley-validate'=>''));?>
      <!-- col -->
      <div class="col-md-12">
