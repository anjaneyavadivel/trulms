...
<?php $this->load->view('admin/msg')?>
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-body">
                                     ...
                                     <?=form_open_multipart(base_url().'add_employee_types',array('class'=>'form-horizontal','id'=>'form4','role'=>'form','data-parsley-validate'=>''));?>
                                ...
                                <div class="tile-footer text-right bg-tr-black lter dvd dvd-top">
                                    <!-- SUBMIT BUTTON -->
                                    <a  href="javascript::" data-toggle="modal" data-target="#active-deactive1" data-options="splash-2 splash-ef-11" role="button" tabindex="0" onclick="active_deactive_class('<?= base_url()?>employee_types','3')" class="btn btn-lightred">Back</a>
