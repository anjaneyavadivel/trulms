                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="javascript::">Update Employee Types</a>
                                </li>
                            </ul>
...
<?php $this->load->view('admin/msg')?>
 ...
 <?=form_open_multipart(base_url().'edit_employee_types/'.$v->employetypeID,array('class'=>'form-horizontal','id'=>'edit_employee_types','role'=>'form'));?>
                                        <div class="form-group">
                                            <label class="control-label">Employee Types Name</label>
                                           
                                                <input type="text" name="typename" class="form-control" placeholder="Employee Types Name" required value="<?=$v->typename?>">
