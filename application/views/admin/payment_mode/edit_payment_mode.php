    ...
    <div class="pageheader">
      ...
      <div class="page-bar">
        <ul class="page-breadcrumb">
          ...
          <li> <a href="javascript::">Update Payment Mode</a> </li>
        </ul>
      </div>
    </div>
      ...
      <div class="col-md-4 insert_forms add_forms">
        ...
        <section class="tile"> 
          ...
          <div class="tile-header bg-greensea  dvd dvd-btm">
            <h1 class="custom-font"><strong>Update</strong> Payment Mode</h1>
          </div>
          <!-- /tile header --> 
          ...
          <div class="tile-body">
             ...
             <?=form_open_multipart(base_url().'edit_payment_mode/'.$v->paymentModeID,array('class'=>'form-horizontal','id'=>'edit_payment_mode','role'=>'form'));?>
              ...
              <div class="tile-footer text-right bg-tr-black lter dvd dvd-top"> 
                ...
                <input type="submit" class="btn bg-greensea" id="add_form" value="Update Payment Mode" >
