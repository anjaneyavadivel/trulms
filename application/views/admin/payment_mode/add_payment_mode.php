...
<?php $this->load->view('admin/msg')?>
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-body">
                                     ...
                                     <?=form_open_multipart(base_url().'add_payment_mode',array('class'=>'form-horizontal','id'=>'add_payment_mode','role'=>'form'));?>

                                        <div class="form-group">
                                            <label class="control-label">Payment Mode Name</label>
                                            
                                                <input type="text" name="paymentMode" class="form-control" placeholder="Payment Mode Name" required>
                                ...
                                <div class="tile-footer text-right bg-tr-black lter dvd dvd-top">
                                    ...
                                    <input type="submit" class="btn bg-greensea" id="add_form" value="Add Payment Mode" >
                                   ...
                                   <a  href="javascript::" data-toggle="modal" data-target="#form-submit" id="form_submiting" data-options="splash-2 splash-ef-11" role="button" tabindex="0"  class="btn btn-greensea" style="display:none">Submit</a>
                                    <input type="submit" class="btn btn-default" id="new_button" onclick="form_submit('add_payment_mode')" value="Submit" style="display:none" >
                                </div>
                                <!-- /tile footer -->
