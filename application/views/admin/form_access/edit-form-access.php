...
<div class="row">
    ...
    <?= form_open_multipart(base_url() . 'edit-form-access/' . $pageRoleMappingID, array('id' => 'form4', 'role' => 'form', 'data-parsley-validate' => '')); ?>
    ...
    <div class="col-md-12">
        ...
        <section class="tile"> 
            ...
            <div class="tile-body">
                ...
                <?php if (isset($pageroleaccessmap) && $pageroleaccessmap->num_rows() > 0) {
                    $v = $pageroleaccessmap->row();
                    ?>
                    <div class="row">
                            ...
                            <select name="pageID" id="pageID" tabindex="3"  required="" class="form-control chosen-select">
                                ...
                                if (isset($pages) && $pages->num_rows() > 0) {
                                    foreach ($pages->result() AS $page) {
                                        ?>
                                        <option value="<?= $page->pageID ?>" <?php
                                                if ($v->pageID == $page->pageID) {
                                                    echo 'selected';
                                                }
                                                ?>><?= ucwords($page->menuCaption); ?></option>
                                                <?php
                                            }
                                        }
                                        ?>
                                ...
                                if (isset($role) && $role->num_rows() > 0) {
                                    foreach ($role->result() AS $rol) {
                                        ...
                                        <option value="<?= $rol->roleID ?>" <?php
                                                if ($v->roleID == $rol->roleID) {
                                                    echo 'selected';
                                                }
                                                ?>><?= ucwords($rol->roleName); ?></option>
            <?php
        }
    }
    ?>
                            ...
                            <div class="col-sm-2">
                                ...
                                <label class="checkbox checkbox-custom-alt">
                                    <input type="checkbox" name="createEnabled" 
                                           ...
                                           value="1" <?php
    if ($v->createEnabled == 1) {
        echo 'checked';
    }
    ?>><i></i> Create Permission
                                </label>
                            ...
                            <div class="col-sm-2">
                                ...
                                <label class="checkbox checkbox-custom-alt">
                                    <input type="checkbox" name="modifyEnabled" 
                                           data-parsley-trigger="change"
                                           value="1" <?php
    if ($v->modifyEnabled == 1) {
        echo 'checked';
    }
    ?>><i></i> Modify Permission
                                </label>
                            ...
                            <div class="col-sm-2">
                                ...
                                <label class="checkbox checkbox-custom-alt">
                                    <input type="checkbox" name="approveEnabled" 
                                           data-parsley-trigger="change"
                                           value="1" <?php
                                           if ($v->approveEnabled == 1) {
                                               echo 'checked';
                                           }
                                           ?>><i></i> Approve Permission
                                </label>
                            ...
                            <div class="col-sm-2">
                                ...
                                <label class="checkbox checkbox-custom-alt">
                                    <input type="checkbox" name="deleteEnabled" 
                                           data-parsley-trigger="change"
                                           value="1" <?php
                                           if ($v->deleteEnabled == 1) {
                                               echo 'checked';
                                           }
                                           ?>><i></i> Delete Permission
                                </label>
