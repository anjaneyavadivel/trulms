    ...
    <div class="col-md-12">
        ...
        <section class="tile"> 
            ...
            <div class="tile-header dvd dvd-btm bg-greensea">
                <h1 class="custom-font"><strong>View <?= $pageTitle ?> History</strong> </h1>
            ...
            <div class="tile-body"> 
                ...
                <div class="tile-footer text-right bg-tr-black lter dvd dvd-top"> 
                    ...
                    <a href="javascript:void(0);" class="btn btn-warning form4SubmitClose"><i class="fa fa-times-circle"></i> Close</a>
                      <?php
                    if (selfAllowed($pagealterpermission, 'selfApprovalAllowed', $v->createby) && checkpageaccess('form-access', 1, 'approve')) {
                    ?>
                   <a href="<?=base_url() . "form-access-mod-approve/" . $v->pageRoleMapping_modID?>" data-toggle="modal" data-target="#active-deactive1" data-options="splash-2 splash-ef-11" role="button" tabindex="0" class="btn btn-greensea mr-5 " onclick="active_deactive_class('<?=base_url() . "form-access-mod-approve/" . $v->pageRoleMapping_modID?>','2')" data-toggle="tooltip" data-placement="top" title="" data-original-title="Click to Approve"><i class="fa fa-thumbs-o-up"></i> Approve</a>
                       <?php
                    }
                    ?>
              </div>
