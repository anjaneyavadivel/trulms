    ...
    <?php if (isset($pagealt) && $pagealt->num_rows() > 0) {
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="onoffswitch labeled greensea inline-block">
                                                <input type="checkbox" name="isSelfEditAllowed" class="onoffswitch-checkbox" id="isSelfEditAllowed"  <?php
        ...
        ?> value="1">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="onoffswitch labeled greensea inline-block">
                                                <input type="checkbox" name="isSelfApprovalAllowed" class="onoffswitch-checkbox" id="isSelfApprovalAllowed" <?php
        ...
        ?> value="1">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-sm-1">
                                            <div class="onoffswitch labeled  greensea inline-block">
                                                <input type="checkbox" name="iscreateApproveRequired" class="onoffswitch-checkbox" id="iscreateApproveRequired" value="1" <?php
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-sm-1">
                                            <div class="onoffswitch labeled  greensea inline-block">
                                                <input type="checkbox" name="ismodifyApproveRequired" class="onoffswitch-checkbox" id="ismodifyApproveRequired" <?php
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="onoffswitch labeled  greensea inline-block">
                                                <input type="checkbox" name="isReportingUserApproveAllowed" class="onoffswitch-checkbox" id="isReportingUserApproveAllowed" <?php
        ...
        if (isset($role) && $role->num_rows() > 0) {
            foreach ($role->result() AS $rol) {
                ?>
                                                        <option value="<?= $rol->roleID ?>" <?php if ($v1->defaultApproverRoleID == $rol->roleID) {
                    echo 'selected';
                } ?>><?= $rol->roleName ?></option>
                <?php
            }
