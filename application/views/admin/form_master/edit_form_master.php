                    ...
                    <div class="tile-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-sm-1">
                                    <div class="onoffswitch labeled  greensea inline-block">
                                        <input type="checkbox" name="iscreateApproveRequired" class="onoffswitch-checkbox" id="iscreateApproveRequired" value="1" <?php if($v1->iscreateApproveRequired==1){echo 'checked';}?>>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-sm-1">
                                    <div class="onoffswitch labeled  greensea inline-block">
                                        <input type="checkbox" name="ismodifyApproveRequired" class="onoffswitch-checkbox" id="ismodifyApproveRequired" <?php if($v1->ismodifyApproveRequired==1){echo 'checked';}?> value="1">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-sm-2">
                                    <div class="onoffswitch labeled  greensea inline-block">
                                        <input type="checkbox" name="isReportingUserApproveAllowed" class="onoffswitch-checkbox" id="isReportingUserApproveAllowed" <?php if($v1->isReportingUserApproveAllowed==1){echo 'checked';}?> value="1">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-sm-2">
                                    <div class="onoffswitch labeled greensea inline-block">
                                        <input type="checkbox" name="isSelfEditAllowed" class="onoffswitch-checkbox" id="isSelfEditAllowed"  <?php if($v1->isSelfEditAllowed==1){echo 'checked';}?> value="1">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-sm-2">
                                    <div class="onoffswitch labeled greensea inline-block">
                                        <input type="checkbox" name="isSelfApprovalAllowed" class="onoffswitch-checkbox" id="isSelfApprovalAllowed" <?php if($v1->isSelfApprovalAllowed==1){echo 'checked';}?> value="1">
