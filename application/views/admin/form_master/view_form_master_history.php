  ...
  <div class="row"> 
            <?php $this->load->view('admin/msg')?>
                      <?php if(isset($pages) && $pages->num_rows()>0){ $v=$pages->row();?>
            <!-- col -->
           <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="parentID" class="form-control mb-10" disabled="" data-parsley-trigger="change" required="" data-parsley-id="3888">
                                    ...
                                    <option value="1" <?php if($v->parentID==1){echo 'selected';}?>>Master</option>
                                    <option value="2" <?php if($v->parentID==2){echo 'selected';}?>>Setup</option>
                                    <option value="3" <?php if($v->parentID==3){echo 'selected';}?>>Operations</option>
                                    <option value="4" <?php if($v->parentID==4){echo 'selected';}?>>Report</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="tile-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-sm-1">
                                    <div class="onoffswitch labeled  greensea inline-block">
                                        <input type="checkbox" name="iscreateApproveRequired" disabled="" class="onoffswitch-checkbox" id="iscreateApproveRequired" value="1" <?php if($v1->iscreateApproveRequired==1){echo 'checked';}?>>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-sm-1">
                                    <div class="onoffswitch labeled  greensea inline-block">
                                        <input type="checkbox" name="ismodifyApproveRequired" disabled="" class="onoffswitch-checkbox" id="ismodifyApproveRequired"  <?php if($v1->ismodifyApproveRequired==1){echo 'checked';}?> value="1">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-sm-2">
                                    <div class="onoffswitch labeled  greensea inline-block">
                                        <input type="checkbox" name="isReportingUserApproveAllowed" disabled="" class="onoffswitch-checkbox" id="isReportingUserApproveAllowed"  <?php if($v1->isReportingUserApproveAllowed==1){echo 'checked';}?> value="1">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-sm-2">
                                    <div class="onoffswitch labeled greensea inline-block">
                                        <input type="checkbox" name="isSelfEditAllowed" disabled="" class="onoffswitch-checkbox" id="isSelfEditAllowed"  <?php if($v1->isSelfEditAllowed==1){echo 'checked';}?> value="1">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-sm-2">
                                    <div class="onoffswitch labeled greensea inline-block">
                                        <input type="checkbox" name="isSelfApprovalAllowed" disabled="" class="onoffswitch-checkbox" id="isSelfApprovalAllowed"  <?php if($v1->isSelfApprovalAllowed==1){echo 'checked';}?> value="1">
