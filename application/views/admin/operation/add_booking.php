    ...
    <div class="row"> 
      ...
      <div class="col-md-12"> 
        ...
        <section class="tile"> 
          ...
          <div class="tile-header dvd bg-greensea dvd-btm">
                                    <h1 class="custom-font"><strong>Docket Details</strong> </h1>
          ...
          <div class="tile-body">
              ...
              <div class="form-group col-md-3">
                <label for="contactemail">Docket Number </label>
              ...
              <div class="form-group name_class col-md-3">
                <label for="name">Service Tax Payable by</label>
                <select  name="name" id="name" required class="form-control"  >
                <option value="">-- Select Booking --</option>
                    <option value="1" >Consinor</option>
                </select>
               <ul class="parsley-errors-list" id="parsley-id-1328">
                </ul>
              ...
              <div class="row">
               <div class="form-group col-md-3">
                ...
                <ul class="parsley-errors-list" id="parsley-id-1328">
              	...
              	<div class="form-group col-md-3">
                <label for="contactemail">Expected Date</label>
                <input type="text" name="dated" id="contactemail" required class="form-control datepicker "  placeholder="MM-DD-YYYY" data-format="L" data-parsley-id="1328">
                <ul class="parsley-errors-list" id="parsley-id-1328">
                </ul>
              </div>
              ...
              <div class="form-group col-md-3">
                ...
                <div class="col-sm-2">
                  <div class="onoffswitch labeled greensea inline-block">
                    <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" id="switch05c" checked="">
                    <label class="onoffswitch-label" for="switch05c"> <span class="onoffswitch-inner"></span> <span class="onoffswitch-switch"></span> </label>
                  </div>
                </div>
              </div>
              </div>
      ...
      <div class="col-md-12"> 
        ...
        <section class="tile"> 
          ...
          <!-- /tile header --> 
          <div class="tile-header dvd bg-greensea dvd-btm">
                                    <h1 class="custom-font"><strong>Consignee  </strong> </h1>
      ...
      <div class="col-md-6">
        <section class="tile"> 
          ...
          <div class="tile-header dvd dvd-btm bg-greensea">
                                    <h1 class="custom-font"><strong>Booking	Details</strong> </h1>
          ...
          <div class="tile-body">
            ...
            <div class="row">
              <div class="form-group col-md-12">
                <label for="name">Number of Pakages </label>
                <input type="text" name="contractCode" id="contractCode" class="form-control" required="" placeholder=" Enter Number of Pakages" data-parsley-id="8057">
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
            ...
            <div class="row">
              <div class="form-group col-md-6">
                <label for="name">Private Marking </label>
                <input type="text" name="vehicleLength" id="name" class="form-control" placeholder=" Enter Private Marking" data-parsley-id="8057">
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
              <div class="form-group col-md-6">
                <label for="contactemail">Type of Packing</label>
                <input type="text" name="vehicleCapacity" id="contactemail"  class="form-control" placeholder=" Enter Type of Packing" data-parsley-id="1328">
                <ul class="parsley-errors-list" id="parsley-id-1328">
                </ul>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-6">
                <label for="contactemail">Basic of Booking</label>
              ...
              <div class="form-group col-md-6">
                <label for="name">Dimension Inches</label>
                <input type="text" name="roadType" id="name" class="form-control" placeholder="Enter Dimension Inches"  data-parsley-id="8057">
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-6">
                <label for="contactemail">Actual Weight</label>
                <input type="text" name="seasonType" id="contactemail"  class="form-control" placeholder="Enter Actual Weight" data-parsley-id="1328">
                <ul class="parsley-errors-list" id="parsley-id-1328">
                </ul>
              </div>
              <div class="form-group col-md-6">
                <label for="name">Charged Weight</label>
                <input type="text" name="miscType" id="name" class="form-control" placeholder="Enter Charged Weight"  data-parsley-id="8057">
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-6">
                <label for="contactemail">Invoice/Dc no</label>
                <input type="text" name="dated" id="contactemail" required class="form-control "  placeholder="Enter Invoice/Dc no" data-format="L" data-parsley-id="1328">
                <ul class="parsley-errors-list" id="parsley-id-1328">
                </ul>
              </div>
              <div class="form-group col-md-6">
                <label for="name">Invoice Value</label>
                <input type="text" name="signedby" id="name" class="form-control" required="" data-parsley-id="8057" placeholder="Enter Invoice Value">
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                <label for="name">Description (said to Contain)</label>
                <input type="text" name="signedby" id="name" class="form-control" required="" data-parsley-id="8057" placeholder="Enter Description">
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-6">
                <label for="name">Speacial Intructions</label>
                <input type="text" name="signedby" id="name" class="form-control" required="" data-parsley-id="8057" placeholder="Enter Speacial Intructions">
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
              <div class="form-group col-md-6">
                <label for="name">Insurance Details (If any)</label>
                <input type="text" name="signedby" id="name" class="form-control" required="" data-parsley-id="8057" placeholder="Enter Insurance Details">
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
            </div>
