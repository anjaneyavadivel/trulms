...
<section id="content">
  <div class="page page-forms-validate">
    ...
    <!-- row -->
    <div class="row"> 
      <?=form_open_multipart(base_url().'add_driver ',array('id'=>'form4','role'=>'form','data-parsley-validate'=>''));?>
      <!-- col -->
      <div class="col-md-12"> 
          ...
          <div class="tile-body">
            <div class="row">
             ...
             <div class="form-group col-md-3">
                ...
                <input type="text" name="dlno" id="dlno"required placeholder=" Enter Lisense" reqiired class="form-control"  data-parsley-id="8057">
                <ul class="parsley-errors-list" id="parsley-id-8057">
                </ul>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="form-group col-md-3">
                ...
                <input type="text" name="dlexpirydt" id="dlexpirydt" required class="form-control datepicker "  placeholder="MM-DD-YYYY" data-format="L" data-parsley-id="1328">
                <ul class="parsley-errors-list" id="parsley-id-1328">
                </ul>
              </div>
            ...
            <div class="row">
              ...
              <div class="form-group col-md-3">
                ...
                <input type="file" name="dlImage" id="dlImage" placeholder=" Enter Address 1" required class="form-control" data-parsley-id="1328">
                <ul class="parsley-errors-list" id="parsley-id-1328">
                </ul>
              </div>
